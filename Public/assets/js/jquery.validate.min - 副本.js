    ...
    t.extend(t.fn, {
        ...
        t.extend(t.validator, {
            ...
            prototype: {
                init: function () {
                    ...
                    t.each(s,
                        ...
                        t(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'],[type='Openaccount'], [type='ratenum'],[type='search'] ,[type='tel'], [type='url'], [type='cccaaa'],[type='Url'],[type='Number_bits'],[type='WX_Appid'],[type='registration'], [type='ID_Card'], [type='Hotline'], [type='mobile'], [type='email'], [type='sxphone'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", e).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", e),
            ...
            methods: {
                ...
                email: function (t, e) {
                    return this.optional(e) || /^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[c]+(om|n)$/i.test(t)
                },
                num: function (t, e) {
                    return this.optional(e) || /^[0-9]*$/i.test(t)
                },
                // 验证码
                cccaaa: function (t, e) {
                    return this.optional(e) || /^[0-9]{6}$/i.test(t)
                },
                Url: function (t, e) {
                    return this.optional(e) || /^(http|https):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?\/$/i.test(t)
                },
                Number_bits:function (t,e) {
                    return this.optional(e) || /[0-9]{21}/i.test(t)
                },
                WX_Appid:function (t,e) {
                    return this.optional(e) || /^wx[a-zA-Z0-9]{16}$/i.test(t)
                },
                // 证件号码
                ID_Card: function (t, e) {
                    return this.optional(e) || /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/i.test(t)
                },
                // 注册号
                registration: function (t, e) {
                    return this.optional(e) || /^[0-9a-zA-Z]{15}$|^[0-9a-zA-Z]{18}$/i.test(t)
                },
                // 客服电话
                Hotline: function (t, e) {
                    return this.optional(e) || /^[0-9]{5,15}$/i.test(t)
                },
                chinese: function (t, e) {
                    return this.optional(e) || /^[\u4E00-\u9FA5\uf900-\ufa2d·]{2,20}$/i.test(t)
                },
                url: function (t, e) {
                    return this.optional(e) || /^(https?|s?ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(t)
                },
                username: function (t, e) {
                    return this.optional(e) || /^[0-9a-zA-Z(_)]*$/i.test(t)
                },
                config: function (t, e) {
                    return this.optional(e) || /^[0-9a-zA-Z(_)(\\\\)(/)(.)]*$/i.test(t)
                },
                fax: function (t, e) {
                    return this.optional(e) || /^((0\d{2,3})?\d{7,8})$/i.test(t)
                },
                zipcode: function (t, e) {
                    return this.optional(e) || /^[0-9]{6}$/i.test(t)
                },
                appid: function (t, e) {
                    return this.optional(e) || !/[\u4e00-\u9fa5]+/i.test(t)
                },
                mobile: function (t, e) {
                    return this.optional(e) || /^\s*$|^1[345789]\d{9}$/i.test(t)
                },
                tennum: function (t, e) {
                    return this.optional(e) || /^\d{10}$/i.test(t)
                },
                sxphone: function (t, e) {
                    return this.optional(e) || /^([0-9]{3,4}-)?[0-9]{7,8}$/i.test(t)
                },
                ratenum: function (t, e) {
                    return this.optional(e) || /^[0](\.\d{1,4})?$/i.test(t)
                },
                date: function (t, e) {
                ...
                Openaccount: function (t, e) {
                    return this.optional(e) || /^[0-9]+(\|[0-9]+)$/i.test(t)
                },
