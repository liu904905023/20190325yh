...
//			$this->assign('systemUserSysNo',$systemUserName);
	...
	public function weixin(){
		...
		$iv     = "yCJXKLv4GvySreYK";
		 $de = $_GET['token_id'];
		 $encryptedData = base64_decode(urldecode($de));
		$decrypted = mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $privateKey, $de, MCRYPT_MODE_CBC, $iv);
echo ((double)$decrypted);exit;
...
//		var_dump($jsApiParameters['PayInfo']);exit;
		$this->assign('jsApiParameters',json_encode($jsApiParameters['PayInfo']));
		$this->display();	
	}
